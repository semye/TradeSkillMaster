...
local OPERATION_INFO = {
	...
	minPrice = { type = "string", default = "check(first(crafting,atrvalue,dbregionmarketavg),max(0.25*avg(crafting,atrvalue,dbregionmarketavg),1.5*vendorsell))" },
	maxPrice = { type = "string", default = "check(first(crafting,atrvalue,dbregionmarketavg),max(5*avg(crafting,atrvalue,dbregionmarketavg),30*vendorsell))" },
	normalPrice = { type = "string", default = "check(first(crafting,atrvalue,dbregionmarketavg),max(2*avg(crafting,atrvalue,dbregionmarketavg),12*vendorsell))" },
